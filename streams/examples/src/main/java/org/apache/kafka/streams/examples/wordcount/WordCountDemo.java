...
public class WordCountDemo {
    ...
    public static void main(String[] args) throws Exception {
      ...
      //  props.put(StreamsConfig.ZOOKEEPER_CONNECT_CONFIG, "localhost:2181");
        props.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "streaming03.dev.dw.sc.gwallet.com:9092");
        props.put(StreamsConfig.ZOOKEEPER_CONNECT_CONFIG, "streaming03.dev.dw.sc.gwallet.com:2181");
        ...
        KStream<String, String> source = builder.stream("streams-file-input-4");
        ...
        counts.to(Serdes.String(), Serdes.Long(), "streams-wordcount-output-4");
